...
$router->get('grids/{projects}/export', ['as' => 'admin.grids.export', 'uses' => 'GridsController@export']);
...
$router->get('grids/{projects}/expeditions/{expeditions}/export', ['as' => 'admin.grids.expedition.export', 'uses' => 'GridsController@export']);
