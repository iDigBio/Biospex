...
Route::get('ajax/wedigbio-progress', [AjaxController::class, 'weDigBioProgress'])->name('ajax.get.wedigbio-progress');
Route::get('ajax/wedigbio-rate', [AjaxController::class, 'weDigBioRate'])->name('ajax.get.wedigbio-rate');
