...
$router->get('events/{events}/transcriptions')->uses('EventsController@exportTranscriptions')->name('webauth.events.exportTranscriptions');
$router->get('events/{events}/users')->uses('EventsController@exportUsers')->name('webauth.events.exportUsers');