...
/**
 * EventTeamManager
 * Handles debugging and interaction for the event team Livewire component
 */
export class EventTeamManager {
    constructor(options = {}) {
    ...
    /**
     * Initialize the event team manager
     */
    init() {
        if (this.initialized) {
            return;
    ...
    logDebugInfo() {
        ...
        console.log('EventTeamManager template loaded');
    ...
    attachEventListeners() {
        ...
        const addButtons = document.querySelectorAll('[data-debug*="add-team-btn"]');
        addButtons.forEach(button => {
            button.addEventListener('click', (e) => {
                console.log('Add button clicked - wire:click should trigger addTeam method');
            });
        });
    }
