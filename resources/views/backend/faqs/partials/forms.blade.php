            ...
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i
                                class="fa {!! Html::setIconByRoute(['admin.faqs.categories.edit'], ['fa-minus', 'fa-plus']) !!}"></i>
                    </button>
                </div>
                <!-- /.box-tools -->
            </div>
    ...
    <div class="col-md-6">
        <div class="box box-primary {!! Html::collapse(['admin.faqs.edit', 'admin.faqs.create']) !!} box-solid">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i
                                class="fa {!! Html::setIconByRoute(['admin.faqs.edit', 'admin.faqs.create'], ['fa-minus', 'fa-plus']) !!}"></i>
                    </button>
                </div>
                <!-- /.box-tools -->
            </div>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group required {{ ($errors->has('answer')) ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                {!! Form::textarea('answer', isset($faq->answer) ? $faq->answer : null, ['class' => 'form-control textarea', 'placeholder' => 'Answer']) !!}
