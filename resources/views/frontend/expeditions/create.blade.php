    ...
    <div class="col-xs-12">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                {!! Form::open([
                'route' => ['admin.expeditions.store', $project->id],
                'method' => 'post',
                ...
                <h4>{{ trans_choice('pages.subjects_assigned', 1) }} <span id="max">{{ trans('pages.subjects_assigned_max', ['count' => Config::get('config.expedition_size')]) }} </span>: <span id="subject-count-html">0</span></h4>
                <div id="jqtable">
