        ...
        <div class="row">
            <div class="col-md-4">
                <button title="@lang('pages.dataTitle')" class="btn btn-inverse btn-sm" type="button"
                        onClick="location.href='{{ route('admin.imports.import', [$project->id]) }}'"><span
                ...
                <button title="@lang('pages.duplicateTitle')" class="btn btn-success btn-sm" type="button"
                        onClick="location.href='{{ route('admin.projects.duplicate', [$project->id]) }}'"><span
            ...
            <div class="col-md-2">
                <button title="@lang('pages.ocrTitle')" class="btn btn-success btn-sm" type="button"
                        ...
                        onClick="location.href='{{ route('admin.projects.ocr', [$project->id]) }}'">
            ...
            <div class="col-md-6">
                <p class="eyesright"><strong>@lang('pages.project_url')
                        :</strong> {!! link_to_route('projects.get.slug', $project->title, [$project->slug]) !!}
                </p>
                <button title="@lang('pages.advertiseTitle')" class="btn btn-success btn-sm" type="button"
                        onClick="location.href='{{ route('admin.advertises.index', [$project->id]) }}'"><span
                ...
                @can('isOwner', $project->group)
                    <button title="@lang('pages.projectStatsTitle')" class="btn btn-success btn-sm"
                            type="button"
                            onClick="location.href='{{ route('admin.statistics.index', [$project->id]) }}'">
...
<h3>{{ trans('pages.expeditions') }}
    <button class="btn btn-success" title="@lang('pages.createTitleE')"
            onClick="location.href='{{ URL::route('admin.expeditions.create', [$project->id]) }}'"><span
