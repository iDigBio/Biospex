...
<li><a href="{{ route('front.faqs.index') }}">{{ trans('pages.faq') }}</a></li>
<li><a href="{{ route('front.resources.index') }}">{{ trans('pages.resources') }}</a></li>
<li><a href="{{ route('home.get.contact') }}">{{ trans('pages.contact') }}</a></li>
<li><a href="{{ route('front.teams.index') }}">{{ trans('pages.team') }}</a></li>
<!-- Navbar Right Menu -->
@can('admin', Auth::user())
