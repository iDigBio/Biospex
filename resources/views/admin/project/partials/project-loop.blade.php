        ...
        <div class="row card-body pb-2">
            ...
            <div class="col-12">
                <ul class="text">
                    ...
                    <li class="smalltext">{{ Count::projectTranscriberCount($project->id) }} {{ t('Participants') }}</li>
                    <li class="smalltext">{{ Count::projectTranscriptionCount($project->id) }} {{ t('Digitizations') }}</li>
                </ul>
            </div>
        </div>
