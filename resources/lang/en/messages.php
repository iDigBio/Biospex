...
return [
    ...
    'expedition_batch_remaining'          => '{0}|{1} :count batch remaining in export queue.|[2,*] :count batches remaining in export queue.',
    'expedition_export_complete_message'  => 'The export process for ":expedition batch :batch" has been completed successfully. :batchRemaining If a download file was created during this process, you may access the link on the Expedition view page. If there were errors, an attachment will be included with this email.',
