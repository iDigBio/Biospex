...
/**
 * Class PanoptesTranscriptionGatewayController
 *
 * @package App\Http\Controllers\Api\PanoptesTranscription
 */
class PanoptesTranscriptionGatewayController extends GatewayController
{
    /**
     * @var string[]
     */
    protected $apiControllers = [
        PanoptesTranscriptionV1Controller::class
    ];
}