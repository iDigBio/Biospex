...
use Biospex\Repositories\Contracts\PermissionInterface;
...
class UsersController extends Controller {
    ...
    )
	{
        ...
        // Establish Filters
        $this->middleware('auth', ['except' => ['register', 'activate', 'resend', 'forgot', 'reset', 'store']]);
    ...
    {
        $registration = Config::get('variables.registration');
