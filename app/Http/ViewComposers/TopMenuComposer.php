<?php  namespace Biospex\Http\ViewComposers;
/**
 * TopMenu.php
 *
...
use Biospex\Repositories\Contracts\NavigationInterface as Navigation;
...
class TopMenuComposer {
    ...
    {
        $this->topmenu = Cache::rememberForever('biospexMenu', function()
        {
