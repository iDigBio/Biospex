...
class AppCommand extends Command
{
    ...
    /**
     * @var \App\Console\Commands\ActorImageService
     */
     ...
     */
    public function __construct(ActorImageService $actorImageService)
    {
        parent::__construct();
    ...
    {
        $dir = storage_path('app/scratch/2-33a72b22-f702-4088-9833-ebbad90b7c17/tmp');
        dd($dir);
        $this->actorImageService->archivePhar->buildFromDirectory($dir);
    }
