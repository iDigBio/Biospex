...
class ProjectPresenter extends Presenter
{
    ...
    public function projectPageIconLrg()
    {
        ...
        return $this->model->slug == null ? '' : '<a href="'.$route.'" target="_blank" data-hover="tooltip" title="Project Page"><i class="fas fa-project-diagram fa-2x"></i></a>';
    }
    ...
    public function projectEventsIcon()
    {
        ...
        return $this->model->events_count == null ? '' : '<a href="'.$route.'#events" data-hover="tooltip" title="Events"><i class="far fa-calendar-times"></i></a>';
    }
    ...
    {
        return $this->model->organization_website == null ? '' : '<a href="'.$this->model->organization_website.'" target="_blank" data-hover="tooltip" title="Organization"><i class="fas fa-building"></i></a>';
    }
    ...
    {
        return $this->model->twitter == null ? '' : '<a href="'.$this->model->twitter.'" target="_blank" data-hover="tooltip" title="Twitter"><i class="fab fa-twitter"></i></a>';
    }
    ...
    {
        return $this->model->twitter == null ? '' : '<a href="'.$this->model->twitter.'" target="_blank" data-hover="tooltip" title="Twitter"><i class="fab fa-twitter fa-2x"></i></a>';
    }
    ...
    {
        return $this->model->facebook == null ? '' : '<a href="'.$this->model->facebook.'" target="_blank" data-hover="tooltip" title="Facebook"><i class="fab fa-facebook"></i></a>';
    }
    ...
    {
        return $this->model->facebook == null ? '' : '<a href="'.$this->model->facebook.'" target="_blank" data-hover="tooltip" title="Facebook"><i class="fab fa-facebook fa-2x"></i></a>';
    }
    ...
    {
        return $this->model->blog_url == null ? '' : '<a href="'.$this->model->blog_url.'" target="_blank" data-hover="tooltip" title="Blog"><i class="fab fa-blogger-b"></i></a>';
    }
    ...
    {
        return $this->model->blog_url == null ? '' : '<a href="'.$this->model->blog_url.'" target="_blank" data-hover="tooltip" title="Blog"><i class="fab fa-blogger-b fa-2x"></i></a>';
    }
    ...
    {
        return $this->model->contact_email == null ? '' : '<a href="mailto:'.$this->model->contact_email.'" data-hover="tooltip" title="Contact"><i class="far fa-envelope"></i></a>';
    }
    ...
    {
        return $this->model->contact_email == null ? '' : '<a href="mailto:'.$this->model->contact_email.'" data-hover="tooltip" title="Contact"><i class="far fa-envelope fa-2x"></i></a>';
    }
