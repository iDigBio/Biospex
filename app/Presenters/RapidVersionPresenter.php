...
class RapidVersionPresenter extends Presenter
{
    /**
    ...
    {
        $filePath = config('config.rapid_version_dir').'/'.$this->model->file_name;
        $timestamp = now()->addMinutes(30);
        $response = ['ResponseContentDisposition' => 'attachment;filename='.$this->model->file_name];
