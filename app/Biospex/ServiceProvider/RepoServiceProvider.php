...
class RepoServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $app->bind('Biospex\Repo\Transcription\TranscriptionInterface', 'Biospex\Repo\Transcription\TranscriptionRepository');
        $app->bind('Biospex\Repo\UserGridField\UserGridFieldInterface', 'Biospex\Repo\UserGridField\UserGridFieldRepository');
