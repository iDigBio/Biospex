            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <button title="@lang('buttons.ocrTitle')" class="btn btn-success btn-xs" type="button" onClick="location.href='{{ action('ExpeditionsController@ocr', [$expedition->project->id]) }}'"><span class="glyphicon glyphicon-repeat"></span> @lang('buttons.ocr')</button>
                        </div>
                        <div class="col-md-4">
