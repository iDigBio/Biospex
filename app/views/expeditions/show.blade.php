...
<div class="well clearfix">
    ...
    <div class="col-md-4">
        ...
        <button class="btn btn-success btn-xs" {{ isset($workflowManager->id) ? 'disabled="disabled"' : '' }} onClick="location.href='{{ action('process', [$groupId, $project->id, $expedition->id]) }}'">@lang('buttons.process')</button>
