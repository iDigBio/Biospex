...
<div id="banner" style="background: url( {{ $project->banner->url()) }} ) top left no-repeat; heig">
	<div class="container">
		<div class="col-md-12">
			<img src="{{ $project->logo->url() }}" alt="{{ $project->title }}" style="border: 5px solid #fff; margin-top: 100px; margin-left: -20px;"/>
		</div>
	</div>
</div>
<br clear="all"/>&nbsp;
