    ...
    <table class="table table-striped table-hover dataTable">
        ...
        <tr>
            ...
            <td class="nowrap">
                ...
                <button title="@lang('buttons.downloadTitle')" class="btn btn-success btn-xs" type="button" onClick="location.href='{{ action('ExpeditionsController@download', [$project->id, $expedition->id]) }}'"><span class="glyphicon glyphicon-file"></span> <!-- @lang('buttons.download') --></button>
                @endif
            </td>
        </tr>
        @endforeach
