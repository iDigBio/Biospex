...
<div class="table-responsive">
    <table class="table table-striped table-hover dataTable">
        ...
        <tr>
            ...
            <td>37.5%</td>
            <td class="nowrap">
                <button class="btn btn-info btn-xs" type="button" onClick="location.href='{{ action('ExpeditionsController@show', [$project->group_id, $project->id, $expedition->id]) }}'">@lang('buttons.view')</button>
                <button class="btn btn-primary btn-xs" type="button" onClick="location.href='{{ URL::route('expedition-dup', [$project->group_id, $project->id, $expedition->id]) }}'">@lang('buttons.duplicate')</button>
                <button class="btn btn-warning btn-xs" type="button" onClick="location.href='{{ action('ExpeditionsController@edit', [$project->group_id, $project->id, $expedition->id]) }}'">@lang('buttons.edit')</button>
