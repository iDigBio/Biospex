...
use App\Models\Rapid as Model;
use App\Repositories\Interfaces\Rapid;

class RapidRepository extends MongoDbRepository implements Rapid
{
    /**
     * OrderBy
     *
     ...
     *
     * @return \App\Models\Rapid|string
     */
