 ...
 * Class SiteAsset
 */
class SiteAsset extends Resource
{
    /**
     * The model the site-asset corresponds to.
     *
     * @var string
     */
    public static $model = 'App\Models\SiteAsset';

    /**
     * The single value that should be used to represent the site-asset when being displayed.
     *
     * @var string
     */
    ...
    /**
     * Get the fields displayed by the site-asset.
     *
     * @return array
     */
            ...
            File::make('Document')
                ...
                ->displayUsing(function ($value, $resource, $attribute) {
                    ...
                    if (isset($resource->document_file_name) && $resource->document_file_name) {
                        ...
                        $oldPath = "paperclip/App/Models/SiteAsset/documents/{$idPartition}/original/{$resource->document_file_name}";
                        $status = '';
    ...
    /**
     * Get the filters available for the site-asset.
     *
     * @return array
     */
    ...
    /**
     * Get the lenses available for the site-asset.
     *
     * @return array
     */
    ...
    /**
     * Get the actions available for the site-asset.
     *
     * @return array
     */
