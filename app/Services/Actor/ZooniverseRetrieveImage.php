...
/**
 * Class ZooniverseRetrieveImage
 *
 * @package App\Services\Actor
 */
class ZooniverseRetrieveImage extends ZooniverseBase implements ActorInterface
{
    /**
    ...
    /**
     * ZooniverseRetrieveImage constructor.
     *
    ...
    public function process(Actor $actor)
    {
        ...
        try {
            $files->chunk(5)->each(function ($chunk) use (&$queue) {
                $this->actorImageService->retrieveImages($chunk, $this->workingDirectory);
