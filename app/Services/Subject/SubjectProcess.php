...
use Biospex\Repositories\Contracts\MetaInterface;
...
class SubjectProcess {
	...
	)
	{
		...
		$this->identifiers = Config::get('variables.identifiers');
		$this->ocrCrop = Config::get('variables.ocrCrop');
        $this->disableOcr = Config::get('variables.disableOcr');
		$this->queue = Config::get('variables.tubes.ocr');
