...
use App\Services\Model\TranscriptionLocationService;
use GeneralHelper;
...
{
    /**
     * @var \App\Services\Model\TranscriptionLocationService
     */
    private $transcriptionLocationService;

    /**
     * @var \App\Services\Model\StateCountyService
     */
    private $stateCountyService;
     ...
     *
     * @param \App\Services\Model\TranscriptionLocationService $transcriptionLocationService
     * @param \App\Services\Model\StateCountyService $stateCountyService
     */
    public function __construct(
        TranscriptionLocationService $transcriptionLocationService,
        StateCountyService $stateCountyService
    )
    {

        $this->transcriptionLocationService = $transcriptionLocationService;
        $this->stateCountyService = $stateCountyService;
    ...
    public function buildTranscriptionLocation($transcription, $subject, $expeditionId)
    {
        ...
        $this->transcriptionLocationService->updateOrCreate($attributes, $values);
    }
